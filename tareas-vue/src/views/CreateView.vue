<template>
  ...
  <div class="col-md-6 offset-md-3"></div>
      <div class="card">        
          <div class="card-header bg-dark text-white text-center">Crear Tarea</div>
...
<script>
  ...
  export default{
    data(){
      return {titulo:'', estado:'', url: 'http://127.0.0.1:8001/api/tarea'}
    },
    methods: {
      guardar(){
          ...
          if(this.estado.trim() === ''){
            ...
            enviarSolicitud('POST', parametros, this.url,'tarea creada');
          }
      }
    }
  }
